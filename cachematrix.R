...
## makeCacheMatrix: This function creates a special "matrix" object that can cache its inverse. It is really a list containing functions to
...
makeCacheMatrix <- function(x = matrix()) {
      ...
      matrix_inverse <- NULL                                ## erases any cached inverse Matrix that may exist in variable 
